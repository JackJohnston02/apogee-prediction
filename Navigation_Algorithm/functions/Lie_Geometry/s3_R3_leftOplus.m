function [Xh] = s3_R3_leftOplus(X,Xe)
% Function to perform the Box Plus (+) operation on elements M2, M1 of
% the S3xR3 and SO3 Special Orthogonal Groups.
%
% Inputs:
% M2,M1 - S3/SO(3) Manifolds / S3/SO(3) States
%
% Outputs:
% wv - 3x1 Box Plus State in a Rotation Vector representation 
%
...
switch n
    ...
    case 7
        ...
        Xh(1:3,1) = s3_logmap(real(quatmultiply(X(1:4)',Xeq')'));

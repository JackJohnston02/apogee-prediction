classdef Navigation_Algorithm
    ...
    methods
        ...
        function obj = updateNavigationStates(obj,buffer,qtruened)
            ...
            if any(~isnan(buffer.y_acc)) && obj.filters.translationKF.settings.propagateWithAccelerometer
                obj.filters.translationKF = obj.filters.translationKF.propagateAccelerometer(buffer.y_acc);
            else
            ...
            if any(~isnan(buffer.y_acc)) && obj.filters.translationKF.settings.useAccUpdate
                ...
                obj.filters.translationKF = obj.filters.translationKF.updateAccelerometer(obj.filters.attitudeKF.q,qtruened,buffer.y_acc);
            end
            % GPS Correction Step
            ...
            if ~isnan(buffer.y_mag)
                ...
                obj.filters.attitudeKF = obj.filters.attitudeKF.updateMagnetometer(buffer.y_mag,r_mag);
            end

%% TODO
% Impliment reverse KF and then average?
...
% Initialise the timestamps and convert to seconds
...
%% Plotting states
% Plot the logs of the estimates
figure;
subplot(3,1,1);
...
xlabel('Time (s)');
ylabel('Velocity (m/s)');
title('Estimated Velocity vs Actual Velocity');

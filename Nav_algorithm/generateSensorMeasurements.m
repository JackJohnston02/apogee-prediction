...
for i = 1:sim.numTimeSteps
    sensor.gyro.omega_b_meas(i,:) = sim.omega_b(i,:) + sensor.gyro.bias(i,:) + sensor.gyro.biasNoiseSTD*randn(1,3) + sensor.gyro.noiseSTD*randn(1,3);
end

%% Acceletometer Measurements

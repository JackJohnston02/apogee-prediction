classdef MEKF < Kalman_Filter
    ...
    methods
        ...
        function obj = propagate(obj,y_omega)
            ...
            obj.q = quatmultiply(s3_expmap(obj.omega*obj.Ts)',obj.q')';
        ...
        function obj = updateMagnetometer(obj,y_mag,r_mag,qtruened)
            %METHOD1 Summary of this method goes here
            %   Detailed explanation goes here
            ...
            r_mag_b = quatrotate(quatconj(obj.q'),r_mag)';
        ...
        function obj = updateAccelerometer(obj,y_acc,a_ned_est)
            ...
            % (LIEKF Update)
            r_grav_b = quatrotate(quatconj(obj.q'),r_grav')';

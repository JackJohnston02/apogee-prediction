classdef UKF_constant_acceleration
    ...
    % Includes apogee prediction method, which consists of a series of
    ...
    methods
        function obj = UKF_constant_acceleration(initial_state, initial_covariance, sigma_Q, sigma_Q_Cb, measurement_sigma_acc, measurement_sigma_bar, t)
            obj.x = initial_state;

classdef CKF_constant_acceleration
    ...
    methods
        function obj = CKF_constant_acceleration(initial_state, initial_covariance, sigma_Q, sigma_Q_Cb, measurement_sigma_acc, measurement_sigma_bar, t)
            obj.x = initial_state;
        ...
        function cubature_points = processModel(obj, cubature_points, dt)
            ...
            for i = 1:num_points
                ...
                x_s(3) = x_s(3);
                x_s(4) = x_s(4);
                % x_s(3) remains unchanged in this model
                % x_s(4) remains unchanged in this model

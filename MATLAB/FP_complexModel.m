function [alt_lower_bound, alt_mean, alt_upper_bound] = FP_complexModel(x, P, t, dt)
...
%   Detailed explanation goes here
    ...
    rho = 1.225 * (1 - (0.0065 * x(1)) / 288.15)^(9.80665 / (287.05 * 0.0065));%calculate the air density
